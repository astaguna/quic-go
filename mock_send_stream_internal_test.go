...
// Source: github.com/astaguna/quic-go (interfaces: SendStreamI)
...
import (
	...
	ackhandler "github.com/astaguna/quic-go/internal/ackhandler"
	protocol "github.com/astaguna/quic-go/internal/protocol"
	qerr "github.com/astaguna/quic-go/internal/qerr"
	wire "github.com/astaguna/quic-go/internal/wire"
)
...
func (m *MockSendStreamI) popStreamFrame(arg0 protocol.ByteCount, arg1 protocol.VersionNumber) (*ackhandler.Frame, bool) {
	m.ctrl.T.Helper()
