...
func (t *Transport) listen(conn rawConn) {
	...
	if err := setReceiveBuffer(t.Conn, t.logger); err != nil {
		if !strings.Contains(err.Error(), "use of closed network connection") {
			setBufferWarningOnce.Do(func() {
				...
				t.logger.Errorf("%s. See https://github.com/astaguna/quic-go/wiki/UDP-Receive-Buffer-Size for details.", err)
			})
		}
	}
	...
	for {
		...
		// See https://github.com/astaguna/quic-go/issues/1737 for details.
